...
export const meetupCreated = createAction('[AllMeetups] Meetup Created', props<{ meetup: Meetup }>());
...
export const meetupChanged = createAction('[AllMeetups] Meetup Changed', props<{ meetup: Meetup }>());
